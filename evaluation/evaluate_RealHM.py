...
if __name__ == '__main__':
    ...
    output_path = '/data1/liguanlin/codes/research_projects/SwinHIH/results/spanet_0720/test_latest/images/'
    ...
    for i, harmonized_path in enumerate(tqdm(harmonized_paths)):
        ...
        fmse_score = torch.nn.functional.mse_loss(harmonized*mask,real*mask)*image_size*image_size/fore_area #计算得到fmse        
