...
class PAB(nn.Module):
    ...
    def __init__(self, 
        ...
        #plug in effective channel attention
        self.conv_weight = 0.01
        self.conv_block = ECA(num_feat=dim)
    ...
    def forward(self, x, x_size):
        ...
        #calculate effective channel attention
        ...
        # FFN
        x = shortcut + self.drop_path(x) + conv_x * self.conv_weight
...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
        ...
        self.blocks = nn.ModuleList([
            PAB(dim=dim, input_resolution=input_resolution,
...
class RPAC(nn.Module):
    """Residual Parallel Attention Collection (RPAC).
...
if __name__ == '__main__':
    ...
    height = 1024 
    width = 1024
    model = LapSwinIH(upscale=1, in_chans=4, img_size=(256, 256),
                   window_size=window_size, img_range=1., depths=[6, 6, 6, 6],
                   embed_dim=60, num_heads=[6, 6, 6, 6], mlp_ratio=2, upsampler='').cuda()
    print(model)
